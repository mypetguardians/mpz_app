...
export function ImageCarouselModal({
  ...
  useOutsideClick(
    modalContentRef as React.RefObject<HTMLElement>,
    () => {
      if (open) {
        onClose();
      }
  ...
  return (
    <div className="fixed inset-0 z-[10001] bg-black/70 flex items-center justify-center animate-in fade-in-0 duration-200">
      <div className="relative w-full h-full">
        ...
        <div className="relative w-full h-full grid place-items-center px-6 sm:px-16">
          ...
          >
            <div ref={emblaRef} className="relative h-full w-full">
